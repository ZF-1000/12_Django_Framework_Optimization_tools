    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.CharField(choices=[('male', 'Мужской'), ('female', 'Женский'), ('other', 'Не указан')], default='other', max_length=6, verbose_name='Пол')),
                ('activation_key', models.CharField(blank=True, max_length=128)),
                ('activation_key_expires', models.DateTimeField(default=datetime.datetime(2020, 8, 31, 11, 26, 3, 913117, tzinfo=utc), verbose_name='актульность ключа')),
