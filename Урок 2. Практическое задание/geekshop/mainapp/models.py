...
# связь "одни ко многим" много продуктов может относиться к одной категории
class Product(models.Model):
    category = models.ForeignKey(ProductCategory, on_delete=models.CASCADE)  # внешний ключ на табличку ProductCategory
